...
function createForm(item, index) {
	f1.innerHTML+='<input type="text" name="alt'+index+'" style="visibility:hidden; width:0px; height:0px;" value="'+M[index]['lat']+'">';
	f1.innerHTML+='<input type="text" name="lat'+index+'" style="visibility:hidden; width:0px; height:0px;" value="'+M[index]['lng']+'">';
